export default function CarouselDemo() {
  ...
  <h1 className="text-5xl md:text-6xl font-bold text-[#66C5CC] mb-8">
    Teamwork: The Core of CarbMines
  </h1>
  <p className="text-white text-xl md:text-2xl">
    At CarbMines, our success is built on collaboration. Our dedicated team, Quantum Quorum, combines diverse expertise and innovation to tackle the challenges of sustainable mining and create impactful solutions together.
  </p>
</div>
    ...
    <div className="md:w-1/2">
      <img 
        src="climb.jpg" 
        alt="CarbMines Hero Illustration" 
  ...
  <div className="grid md:grid-cols-3 gap-12">
    <div className="bg-[#342F49] p-10 rounded-lg shadow-lg border border-[#66C5CC]">
      <div className="flex items-center gap-2 mb-6">
        ...
        <span className="text-base text-[#66C5CC]">CarbMines</span>
      </div>
      <p className="text-lg text-white">
        Our project, CarbMines, is driving change in sustainable mining and has proudly secured a spot in the **Smart India Hackathon 2024 Senior Grand Finale**.
      </p>
    </div>
    <div className="bg-[#342F49] p-10 rounded-lg shadow-lg border border-[#66C5CC]">
      <div className="flex items-center gap-2 mb-6">
